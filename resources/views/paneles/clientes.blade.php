...
<body class="font-sans antialiased">
    ...
    <nav id="nav" x-data="data()" style="transition: margin-left 0.5s;"
        ...
        <div class="px-2 py-3 lg:px-5 lg:pl-3">
            <div class="flex items-center justify-between md:justify-end">
                ...
                <div class="flex items-center justify-start dark:text-gray-200 md:hidden">
                    <button @click="public()"
                    ...
                    <div class="relative mt-2 block" x-data="{ open: false }" @click.away="open = false"
                        ...
                        <div x-show="open" x-transition:enter="transition ease-out duration-200"
                            ...
                            <ul class="py-1" role="none">
                                ...
                                @if (Auth::user()->id_type_user == 1 || Auth::user()->id_type_user == 3 || Auth::user()->id_type_user == 5)
                                    <li>
                                        <a @switch(Auth::user()->id_type_user)
                                            @case(1)
    ...
    <aside id="aside" style="transition: width 0.5s, transform 0.5s;"
        class="z-20 fixed md:hidden top-0 left-0 w-[250px] h-screen bg-zinc-700 pb-5 pl-[15px] pr-[15px] -translate-x-full overflow-hidden  contenedor  md:translate-x-0 md:hover:w-[250px]  dark:bg-gray-800">
                                    ...
                                    <ul class="h-0">
                                        <li class="">
                                            ...
                                            <a href="{{ route('admin.catalogos.index') }}"
                                                class="list_item {{ request()->routeIs('admin.catalogos.index') ? 'link_select' : '' }} ">
                                                <img src="{{ asset('images/option.svg') }}" alt="" class="list_image">
                                                <span class="list_span-aside">Todos los Catálogos</span>
                                            </a>
                                        </li>
